...
#define NL_UNDERWATER_WAVE 0.17       // [toggle] 0.02 subtle ~ 0.6 trippy
#define NL_UNDERWATER_TINT vec3(0.005, 0.047, 0.76)
...
#define NL_AURORA_COL1 vec3(0.0,1.0,0.65)
#define NL_AURORA_COL2 vec3(0.8,0.3,0.9)
...
#define NL_SUNMOON_BRIGHTNESS 1.0
